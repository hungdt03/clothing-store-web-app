        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatestMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastedTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecentOnlineTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressOrders_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Thumbnail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TextPlain = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AddressOrders_AddressOrderId",
                        column: x => x.AddressOrderId,
                        principalTable: "AddressOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EvaluationFavoritesId = table.Column<int>(type: "int", nullable: false),
                    FavoritesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationUser", x => new { x.EvaluationFavoritesId, x.FavoritesId });
                    table.ForeignKey(
                        name: "FK_EvaluationUser_Evaluations_EvaluationFavoritesId",
                        column: x => x.EvaluationFavoritesId,
                        principalTable: "Evaluations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationUser_Users_FavoritesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewShows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewShows_Evaluations_EvaluationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationUser_FavoritesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewShows_EvaluationId",
                table: "ReviewShows",
                column: "EvaluationId");
